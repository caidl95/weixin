...
import cn.yunji.wechats.commom.MyX509TrustManager;
	...
	public static AccessToken getAccessToken(String appid, String appsecret) {
		...
		if (null != jsonObject) {
			try {
				...
				accessToken = null;
				// 获取 token 失败
				log.error("获取 token 失败 errcode:{} errmsg:{}", jsonObject.getInt("errcode"), jsonObject.getString("errmsg"));
			}
		}
		return accessToken;
	}
